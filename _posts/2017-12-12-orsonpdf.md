...
My blog doesn't have a mechanism for commenting, but if you want to provide feedback then you can interact via Twitter: [@david_m_gilbert](https://twitter.com/david_m_gilbert?lang=en).
